...
<div class="limiter">
    <div class="container-login100">
        <div class="wrap-login100">
            <form action="ls" method="post" class="login100-form validate-form"> <%--form submit ile gonderirik--%>
					<span class="login100-form-title p-b-43">
						Member Login to TimeSheet
					</span>

                <div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
                    <input class="input100" type="text" id="usernameId" name="username" >
                ...
                <div class="wrap-input100 validate-input" data-validate="Password is required">
                    <input class="input100" type="password" id="passwordId" name="password">
                    <span class="focus-input100"></span>
                ...
                <c:if test="${not empty message}">
                    <label class="error">
                        Şifrə uğurla dəyişdirildi (Siz ugurla qeydiyyatdan keçdiniz)</label>
                </c:if>
