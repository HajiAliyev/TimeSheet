...
<div class="limiter">
    <div class="container-login100">
        <div class="wrap-login100">
            <form action="cs?action=changePassword" method="post" class="login100-form validate-form"> <%--form submit ile gonderirik--%>
                ...
                <div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
                    <input class="input100" type="password" id="newPasswordId" name="password" placeholder="Type your password">
